...
/*        return $DB->get_field_sql(
        ...
        // TODO create table h5p_libraries_laguages
        return false;
    }
...
// TODO add fields to h5p_libraries: tutorial_url, metadata_settings, restricted
        foreach ($librariesresult as $library) {
            // Remove unique index.
            unset($library->id);

            // TODO Moodle tables don't use _ in the column names
            // Convert snakes to camels.
            $library->majorVersion = (int) $library->majorversion;
            unset($library->majorversion);
            $library->minorVersion = (int) $library->minorversion;
            unset($library->minorversion);
            if (!empty($library->tutorial_url)) {
               $library->tutorialUrl = $library->tutorialurl;
            }
            unset($library->tutorialurl);

            $library->metadataSettings = json_decode($library->metadatasettings);
            unset($library->metadatasettings);

            // TODO $libraries  always [] -- line 152
    ...
    public function getAvailableLanguages($machineName, $majorVersion, $minorVersion) {
        ...
        // TODO create table h5p_libraries_languages

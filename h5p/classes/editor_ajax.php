...
class editor_ajax implements H5PEditorAjaxInterface {
    ...
    public function getLatestLibraryVersions() {
        ...
        $sql = " SELECT hl4.id, hl4.machinename as machine_name, hl4.title, hl4.majorversion as major_version, hl4.minorversion as minor_version,
                        hl4.patchversion as patch_version, '' as has_icon, 0 as restricted

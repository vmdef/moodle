...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2020022100.03) {
        ...
        // Adding primary key to table h5p_contents_languages.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        // Adding unique key to table h5p_contents_languages.
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2020022100.03);
    }

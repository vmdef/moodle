...
class mustache_clean_string_helper {
     ...
     *
     * {{#strs}}activity{{/strs}}
     * {{#strs}}actionchoice, core, {{#str}}delete{{/str}}{{/strs}} (Together with the str helper)
     * {{#strs}}addinganewto, core, {"what":"This", "to":"That"}{{/strs}} (Complex $a)
     *
     ...
     * @return string
     */
    public function strs($text, Mustache_LambdaHelper $helper) {

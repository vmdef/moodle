...
/**
 * Class for exporting the data needed to render a recent activity.
 *
 * @package    core_user
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_recent_activity_exporter extends \core\external\exporter {
    /**
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        return array(
                'viewurl' => (new moodle_url('/mod/'.$this->data->modname.'/view.php', array('id' => $this->data->cmid)))->out(false),

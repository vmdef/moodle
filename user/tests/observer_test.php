 ...
 * @since      Moodle 3.6
 */
class core_user_observer_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        // Recent activities table name.
        $this->table = "recent_activities";
    ...
    /**
     * Test activity views are recorded
     *
     * When activities events are triggered they are stored in the recent_activities table.
     */
    public function test_activity_view_recorded_testcase() {
        global $DB;
        ...
        // Student access assign activity.
        $this->assign->view();
        $records = $DB->get_records($this->table, array('userid' => $this->student->id, 'courseid' => $this->course->id, 'cmid' =>
    ...
    /**
     * Test removed activity records are deleted.
     *
     * When a course module is removed, the records associated in the recent activity table are deleted.
     */
    public function test_activity_delete_record_testcase() {
        global $DB;

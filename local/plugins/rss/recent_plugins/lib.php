...
class local_plugins_rss_recent_plugins_feed extends local_plugins_rss_feed {
    
    /**
     *
     * @var local_plugins_category
     */
    protected $category;
    protected $plugins;
    ...
    public function __construct($id, array $args) {
        ...
        if ($id) {
            ...
            $this->category = new local_plugins_recentplugins();
        }
    }

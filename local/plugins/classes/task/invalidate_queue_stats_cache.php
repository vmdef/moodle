...
/**
 * Invalidates the approval queue stats cache
 *
 * @copyright 2015 David Mudrak <david@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class invalidate_queue_stats_cache extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('taskinvalidatequeuestatscache', 'local_plugins');
    }

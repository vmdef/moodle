...
//    }
    ...
    if ($oldversion < 2014052800) {
        ...
        $DB->set_field('registry', 'privacy', 'notdisplayed', array('hubid' => null, 'privacy' => null, 'public' => 0));
        $DB->set_field('registry', 'privacy', 'named', array('hubid' => null, 'privacy' => null, 'public' => 1));
        $DB->set_field('registry', 'privacy', 'linked', array('hubid' => null, 'privacy' => null, 'public' => 2));
    ...
    if ($oldversion < 2018053100) {
        // Drop the table registry_votes. We are not using it here any more and it contains user's data.
        ...
        upgrade_plugin_savepoint(true, 2018053100, 'local', 'moodleorg');
    }

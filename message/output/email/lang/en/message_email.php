...
$string['smtpemailtestbody'] = 'You have received this email while testing the {$a->server} SMTP server';
$string['smtpemailtestmodaltitle'] = 'SMTP test';
$string['smtpemailtestnoaddress'] = 'Recipient address not specified';
$string['smtpemailtestnoemailever'] = 'Not sending email due to $CFG->noemailever config setting';
$string['smtpemailtestnohost'] = 'No SMTP host specified';
$string['smtpemailtestsubject'] = '[{$a->sitefullname}]: Testing SMTP configuration';

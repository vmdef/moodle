...
class editor extends edit_content {
    ...
    protected function definition() {
        ...
        if ($id) {
            // The H5P editor needs the id of the content to edit.
            $record = $DB->get_record('contentbank_content', ['id' => $id]);
            $tempcontent = new content($record);
            ...
            // The H5P editor needs the content type library for a new content.
    ...
    public function save_content(stdClass $data): int {
        ...
        return $data->id ?? $newcontent->get_id();
    }
}

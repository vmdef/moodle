...
if ($contenttype->can_access()) {
    $contentrenderable = new core_contentbank\output\view_content_page($contenttype, $record);
    $contentrender = $PAGE->get_renderer('core_contentbank');
    echo $contentrender->render($contentrenderable);
} else {

...
/**
 * Javascript to initialise the recentcourses block.
 *
...
define(
    ...
    function(
        ...
        var SELECTORS = {
            COURSES_VIEW: '[data-region="recent-courses-view"]',
            COURSES_VIEW_CONTENT: '[data-region="recent-courses-view-content"]'
        };
        ...
        var renderCourses = function(root, courses) {
            if (courses.length > 0) {
                return Templates.render('block_recentcourses/view-cards', {
                    courses: courses
                });
            } else {
                var nocoursesimgurl = root.attr('data-nocoursesimgurl');
                return Templates.render('block_recentcourses/no-courses', {
         ...
         *
         * @param {int} userid User from which the courses will be obtained
         * @param {object} root The root element for the recentcourses block.
         */

...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtextarea('filter_h5p/allowedsources', get_string('allowedsourceslist', 'filter_h5p'),
            get_string('allowedsourceslistdesc', 'filter_h5p'), "https://h5p.org/h5p/embed/[id]\nhttps://*.h5p.com/content/[id]/embed"));
    $settings->add(new admin_setting_configcheckbox('filter_h5p/resize', get_string('resize', 'filter_h5p'),
        get_string('resizedesc', 'filter_h5p'), 1));

...
class filter_h5p extends moodle_text_filter {
    ...
    public function filter($text, array $options = array()) {
        ...
        foreach ($allowedsources as $source) {
            // Convert wildcards and regexp special chars.
     ...
     */
    public function filterobject_prepare_replacement_callback($tagbegin, $tagend) {
        // "/embed" added at the end of any URL to allow  URLs like https:://*.h5p.com/content/12345.
        $h5piframeattr = "\"$1/embed\" allowfullscreen=\"allowfullscreen\" style=\"border: 0;\">";
        ...
        return [$tagbegin, $tagend, $h5piframeattr];
    }
}

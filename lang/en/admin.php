...
$string['configsmtpemailtest'] = 'If you want to test the current values in the form, add an email address, where a message will be sent, and press the <strong>Test SMTP</strong> button. If you want to save the changes, press <strong>Save changes</strong> button at the bottom of the page. <br /><strong>Notes:</strong><ul><li>If you leave the SMTP username input text empty, SMTP AUTH won\'t be used.</li><li>If multiple STMP hosts are available, they will be tested secuentially.</li><li>Use the "No-reply address" below as the From email address if needed.</li></ul>';
...
$string['smtpemailtest'] = 'Test email address';
$string['smtpemailtestbutton'] = 'Test';

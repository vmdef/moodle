...
$string['privacy:metadata:recent_activitiestablesummary'] = 'Information about the last time a user accessed an activity.';
...
$string['privacy:metadata:timeaccessactivity'] = 'The time of the last access to the activity by the user.';
...
$string['privacy:recentactivitiespath'] = 'Recently accessed activities';
